    ...
    console.log(plus,minus,price,qty,total)
     plus.addEventListener('click',function (){
       ...
       document.querySelector(".total").innerHTML=price*qty
        document.querySelector(".text").innerHTML=Number(document.querySelector(".total").innerHTML)+Number(document.querySelector(".total1").innerHTML)
    })
    minus.addEventListener('click',function (){
     ...
     remove.addEventListener('click',function(){
      document.getElementById("1st").remove()
       document.querySelector(".text").innerHTML=Number(document.querySelector(".total1").innerHTML)
    })
  ...
  remove1.addEventListener('click',function(){
      document.getElementById("2st").remove()
       document.querySelector(".text").innerHTML=Number(document.querySelector(".total").innerHTML)
    })
  }  )
/////////////////////////////////////////////////////////////////////////////
